...
const Hero = () => (
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      <div className='flex flex-row items-center py-[6px] px-4 bg-gradient-to-tr from-lightPrimary to-purplePrimary ... rounded-[10px] mb-2'>
    ...
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
      <img src={robot} alt="billing" className="w-[85%] h-[100%] relative z-[5] top-0 pr-20"/>
      <div className="absolute z-[0] w-[40%] h-[40%] top-0 pink-gradient"/>
